 ...
 * @
 **/
@org.springframework.data.mongodb.core.mapping.Document(collection = "civil_aviation_trajectory")
public class TrackTarget {
    ...
    public TrackTarget(String id, String targetId, List<Document> trackPointItems, Integer handle) {
        this.id = id;
